declare module "resource://app/modules/Interactions.sys.mjs" {export const Interactions: _Interactions;
/**
...
declare class _Interactions {
     ...
     */
    static "__#566584@#updateInteraction_async"(browser: Browser, activeWindow: DOMWindow, userIsIdle: boolean, interactions: WeakMap<Browser, InteractionInfo>, pageViewStartTime: number, store: InteractionsStore): Promise<void>;
    DOCUMENT_TYPE: {
        GENERIC: number;
        MEDIA: number;
    };
