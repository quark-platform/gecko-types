declare module "resource://app/modules/BuiltInThemes.sys.mjs" {export const BuiltInThemes: _BuiltInThemes;
declare class _BuiltInThemes {
     ...
     */
    getLocalizedColorwayGroupName(colorwayId: any): string;
    /**
     * @param {string} id
     *   The ID of the colorway add-on.
     * @return {string}
     ...
     *   there's none.
     */
    getColorwayIntensityL10nId(colorwayId: any): string;
    /**
     * @param {string} id
     *   The ID of the colorway add-on.
     * @return {string}
     ...
     *   there's none.
     */
    getLocalizedColorwayDescription(colorwayId: any): string;
