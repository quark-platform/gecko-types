declare module "resource://gre/modules/FormScenarios.sys.mjs" {export class FormScenarios {
    /**
     * Caches the scores when running the SignUpFormRuleset against a form
     */
    static "__#1264037@#cachedSignUpFormScore": WeakMap<WeakKey, any>;
    /**
     ...
     */
    static "__#1264037@#isProbablyASignUpForm"(formElement: HTMLFormElement): boolean;
}
}