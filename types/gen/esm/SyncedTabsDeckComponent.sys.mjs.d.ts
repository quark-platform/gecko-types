declare module "resource://app/modules/syncedtabs/SyncedTabsDeckComponent.sys.mjs" {export function SyncedTabsDeckComponent({ window, SyncedTabs, deckStore, listStore, listComponent, DeckView, getChromeWindowMock, }: {
    window: any;
    SyncedTabs: any;
    deckStore: any;
    listStore: any;
