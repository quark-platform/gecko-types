declare module "resource://gre/modules/LoginManagerChild.sys.mjs" {export namespace AUTOFILL_RESULT {
    let FILLED: string;
...
export class LoginFormState {
     ...
     */
    static "__#1120999@#removeFillFieldHighlight"(event: any): void;
    /**
