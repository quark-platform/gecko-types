...
export const PageDataService: {
     ...
     */
    "__#567546@#backgroundBrowsers": WeakMap<Browser, (arg0: PageDataParent) => void>;
    /**
     * Tracks windows that have browsers with entries in the cache.
     *
     * @type {Map<Window, Set<Browser>>}
     */
    "__#567546@#trackedWindows": Map<Window, Set<Browser>>;
    /**
     ...
     */
    "__#567546@#trackBrowser"(browser: Browser): void;
    /**
     ...
     */
    "__#567546@#isATabBrowser"(browser: DOMElement): boolean;
};
/**
