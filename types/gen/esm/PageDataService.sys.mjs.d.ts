...
export const PageDataService: {
     ...
     */
    "__#567545@#backgroundBrowsers": WeakMap<Browser, (arg0: PageDataParent) => void>;
    /**
     * Tracks windows that have browsers with entries in the cache.
     *
     * @type {Map<Window, Set<Browser>>}
     */
    "__#567545@#trackedWindows": Map<Window, Set<Browser>>;
    /**
     ...
     */
    "__#567545@#trackBrowser"(browser: Browser): void;
    /**
     ...
     */
    "__#567545@#isATabBrowser"(browser: DOMElement): boolean;
};
/**
