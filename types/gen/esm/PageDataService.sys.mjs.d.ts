...
export const PageDataService: {
     ...
     */
    "__#225835@#backgroundBrowsers": WeakMap<Browser, (arg0: PageDataParent) => void>;
    /**
     * Tracks windows that have browsers with entries in the cache.
     *
     * @type {Map<Window, Set<Browser>>}
     */
    "__#225835@#trackedWindows": Map<Window, Set<Browser>>;
    /**
     ...
     */
    "__#225835@#trackBrowser"(browser: Browser): void;
    /**
     ...
     */
    "__#225835@#isATabBrowser"(browser: DOMElement): boolean;
};
/**
