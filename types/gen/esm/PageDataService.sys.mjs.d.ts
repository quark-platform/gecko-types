...
export const PageDataService: {
     ...
     */
    "__#567552@#backgroundBrowsers": WeakMap<Browser, (arg0: PageDataParent) => void>;
    /**
     * Tracks windows that have browsers with entries in the cache.
     *
     * @type {Map<Window, Set<Browser>>}
     */
    "__#567552@#trackedWindows": Map<Window, Set<Browser>>;
    /**
     ...
     */
    "__#567552@#trackBrowser"(browser: Browser): void;
    /**
     ...
     */
    "__#567552@#isATabBrowser"(browser: DOMElement): boolean;
};
/**
