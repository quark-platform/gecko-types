...
export const PageDataService: {
     ...
     */
    "__#567069@#backgroundBrowsers": WeakMap<Browser, (arg0: PageDataParent) => void>;
    /**
     * Tracks windows that have browsers with entries in the cache.
     *
     * @type {Map<Window, Set<Browser>>}
     */
    "__#567069@#trackedWindows": Map<Window, Set<Browser>>;
    /**
     ...
     */
    "__#567069@#trackBrowser"(browser: Browser): void;
    /**
     ...
     */
    "__#567069@#isATabBrowser"(browser: DOMElement): boolean;
};
/**
