...
export const PageDataService: {
     ...
     */
    "__#566583@#backgroundBrowsers": WeakMap<Browser, (arg0: PageDataParent) => void>;
    /**
     * Tracks windows that have browsers with entries in the cache.
     *
     * @type {Map<Window, Set<Browser>>}
     */
    "__#566583@#trackedWindows": Map<Window, Set<Browser>>;
    /**
     ...
     */
    "__#566583@#trackBrowser"(browser: Browser): void;
    /**
     ...
     */
    "__#566583@#isATabBrowser"(browser: DOMElement): boolean;
};
/**
