declare module "resource://gre/modules/LoginHelper.sys.mjs" {export class ParentAutocompleteOption {
...
export namespace LoginHelper {
    ...
    function createLoginAlreadyExistsError(guid: any): nsIExceptionType;
    /**
