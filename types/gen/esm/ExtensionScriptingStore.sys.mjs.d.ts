declare module "resource://gre/modules/ExtensionScriptingStore.sys.mjs" {export function makeInternalContentScript(extension: Extension, options: object, prependBaseURL?: boolean): object;
