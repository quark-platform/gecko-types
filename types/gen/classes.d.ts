declare var Cc: {
    ...
    ["@mozilla.org/content/dropped-link-handler;1"]: {
        createInstance(): nsIDroppedLinkHandlerType;
    ...
    ["@mozilla.org/intl/stringbundle;1"]: {
        createInstance(): nsIStringBundleServiceType;
    ...
    ["@mozilla.org/intl/texttosuburi;1"]: {
        createInstance(): nsITextToSubURIType;
    ...
    ["@mozilla.org/moz/jssubscript-loader;1"]: {
        createInstance(): mozIJSSubScriptLoaderType;
    ...
    ["@mozilla.org/dom/localStorage-manager;1"]: {
        createInstance(): nsIDOMStorageManagerType;
    ...
    ["@mozilla.org/scriptsecuritymanager;1"]: {
        createInstance(): nsIScriptSecurityManagerType;
    ...
    ["@mozilla.org/prompter;1"]: {
        createInstance(): nsIPromptServiceType;
    ...
    ["@mozilla.org/load-context-info-factory;1"]: {
        createInstance(): nsILoadContextInfoFactoryType;
    ...
    ["@mozilla.org/network/oblivious-http-service;1"]: {
        createInstance(): nsIObliviousHttpServiceType;
    ...
    ["@mozilla.org/toolkit/app-startup;1"]: {
        createInstance(): nsIAppStartupType;
    ...
    ["@mozilla.org/clear-data-service;1"]: {
        createInstance(): nsIClearDataServiceType;
    ...
    ["@mozilla.org/content-blocking-allow-list;1"]: {
        createInstance(): nsIContentBlockingAllowListType;
    ...
    ["@mozilla.org/cookie-banner-rule;1"]: {
        createInstance(): nsICookieBannerRuleType;
    ...
    ["@mozilla.org/enterprisepolicies;1"]: {
        createInstance(): nsIEnterprisePoliciesType;
    ...
    ["@mozilla.org/mozintl;1"]: {
        createInstance(): mozIMozIntlType;
    ...
    ["@mozilla.org/login-manager;1"]: {
        createInstance(): nsILoginManagerType;
    ...
    ["@mozilla.org/browser/search-service;1"]: {
        createInstance(): nsISearchServiceType;
    ...
    ["@mozilla.org/base/daptelemetry;1"]: {
        createInstance(): nsIDAPTelemetryType;
    ...
    ["@mozilla.org/toolkit/URLFormatterService;1"]: {
        createInstance(): nsIURLFormatterType;
    ...
    ["@mozilla.org/xul/xulstore;1"]: {
        createInstance(): nsIXULStoreType;
    ...
    ["@mozilla.org/extensions/blocklist;1"]: {
        createInstance(): nsIBlocklistServiceType;
    ...
    ["@mozilla.org/embedcomp/window-watcher;1"]: {
        createInstance(): nsIWindowWatcherType;
    ...
    ["@mozilla.org/tools/profiler;1"]: {
        createInstance(): nsIProfilerType;
    ...
    ["@mozilla.org/widget/parent/clipboard;1"]: {
        createInstance(): nsIClipboardType;
    ...
    ["@mozilla.org/android/bridge;1"]: {
        createInstance(): nsIAndroidBridgeType;
    ...
    ["@mozilla.org/consoleservice;1"]: {
        createInstance(): nsIConsoleServiceType;
    ...
    ["@mozilla.org/xpcom/version-comparator;1"]: {
        createInstance(): nsIVersionComparatorType;
    ...
    ["@mozilla.org/categorymanager;1"]: {
        createInstance(): nsICategoryManagerType;
    ...
    ["@mozilla.org/process/environment;1"]: {
        createInstance(): nsIEnvironmentType;
